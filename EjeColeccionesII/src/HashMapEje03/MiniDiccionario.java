package HashMapEje03;
/*3. Crea un mini-diccionario español-inglés que contenga, al menos, 10 palabras (con su correspondiente 
 * traducción). Utiliza un objeto de la clase HashMap para almacenar las parejas de palabras.  Realiza 
 * un programa que escoja al azar 5 palabras en español del mini-diccionario. El programa irá pidiendo que 
 * el usuario teclee la traducción al inglés de cada una de las palabras y comprobará si son correctas. Al 
 * final, el programa deberá mostrar cuántas respuestas son
